/obj/item/gun/launcher/rocket
	...
	desc_extended = "The KGM-701 is a heavy anti-tank guided missile in use by the Konyang Army, another carryover from their old Solarian stockpiles. Capable of handling any tank that wouldn't get bogged down on Konyang's soft terrain, \
	the KGM-701 is expected to soldier on for many years to come. This however, is *not* a KGM-701, but the KGM-701D, the unguided discount variation of the old Solarian ATGM, typically issued to colonial garrisons and \
	not rated against any modern vehicles."
